...
const spotifyOpoBuyAction = async (
	...
	try {
		...
		let caption = `Тариф: <b>${service.tariff}</b>\nЦена: <b>${amount}р</b>\n\n Нажмите <b>«К оплате»</b>, чтобы связаться с нашим менеджером.\n <b><i>💳❗️ Он предоставит все необходимые реквизиты для оплаты и ответит на ваши вопросы. </i></b>`;
		...
		if (order) {
			await ctx.telegram.editMessageMedia(
				...
				{
					reply_markup: {
						inline_keyboard: [[Markup.button.url("К оплате", supportLink)]],
					},
				}
			);
		}
